...
import { GameEngine } from "./engine.js?v=10";
import { HostNet, ClientNet } from "./net.js?v=10";
import { C, S, STATUS } from "./protocol.js?v=10";
import { randomCode, sessionToken as makeToken } from "./util.js?v=10";
